...
# Script 4: Person-Centered Analysis
# Purpose: Create person-centered longitudinal visualizations and average plots
...
# ============================================================================
# PERSON-CENTERED PANEL PLOTS
# ============================================================================

cat("\n=== GENERATING PERSON-CENTERED PANEL PLOTS ===\n")

# Create plots for each person-centered variable
for (var in cols_to_plot) {
  ...
  if (!is.null(combined_plot)) {
    filename <- file.path(project_dir, "output", paste0("04_trajectories_person_centered_", gsub(" ", "_", var), ".png"))
...
# ============================================================================
# AVERAGE PERSON-CENTERED PLOTS BY TIMEPOINT
# ============================================================================

cat("\n=== GENERATING AVERAGE PERSON-CENTERED PLOTS BY TIMEPOINT ===\n")
...
for (var in cols_to_plot) {
  ...
  # Save plot
  filename <- file.path(project_dir, "output", paste0("04_average_person_centered_", gsub(" ", "_", var), ".png"))
